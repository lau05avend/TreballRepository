                        ...
                        <form id="form-steper" method="POST"  role="application" wire:submit.prevent="store()" class="wizard clearfix" novalidate="novalidate">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group mb-5">
                                                    ...
                                                    <label class="custom-file-labelll" for="customFile">
                                ...
                                @if ($step == 2)
                                    <fieldset id="form-horizontal-p-2" role="tabpanel" aria-labelledby="form-horizontal-h-2" class="body" aria-hidden="true">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <h3>Asignar usuarios </h3><br><div id="accordionUs" wire:ignore>
                                                        <h3>Ingenieros</h3>
                                                        <div>
                                                            @forelse ($users as $u)
                                                    ...
                                                    </div>{{-- <form method="POST" class="form-as" wire:submit.prevent="ObraUsuarios" }}"> --}}
                            ...
                            <div class="actions clearfix">
                                <ul role="menu" aria-label="Pagination">
                                    ...
                                    @elseif ($step == 2)
                                        <li class="" aria-disabled="true"><a wire:click="decreaseStep()" href="javascript:void(0)" role="menuitem">Anterior</a></li>
                                        <li aria-hidden="false" aria-disabled="false"><a wire:click="submitStep()"  href="javascript:void(0)" role="menuitem">Registrar obra</a></li>
                                    @endif
                                </ul>
                            </div>
                        </form>
